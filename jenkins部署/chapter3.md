...
在系统管理--&gt;系统设置下找到gitlab配置项：![](/assets/04.png)

Credentials点击add：![](/assets/05.png)API token 填写你的gitlab中的token：![](/assets/06.png)

然后点击Test Connection出现success表示成功.

* 权限设置

在 系统管理 --&gt; Configure Global Security下：![](/assets/07.png)
...
![](/assets/09.png)![](/assets/10.png)![](/assets/11.png)两个脚本：
